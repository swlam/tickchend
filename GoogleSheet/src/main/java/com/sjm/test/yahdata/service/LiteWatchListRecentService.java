...
//			CODE_POOL = Arrays.asList("TSLA","QQQ","DIA","SPY");//USStockListConfig.ETF;
...
//			CODE_POOL = Arrays.asList("9992.HK","2800.HK","2822.HK","3033.HK");//USStockListConfig.ETF;
