...
public class WeeklyHighRule extends VolRuleBase {

	private CandleEventTagEnum SIGN = CandleEventTagEnum.EVNT_WEEKLY_H;

	public WeeklyHighRule() {
	}
	...
	public boolean detect(List<StockBean> prevList, StockBean curr) {
		...
		try {
			...
			if (curr.getH() > wHBean.getH() && curr.getBodyTop() > wHBean.getBodyTop())
