...
public class VolIncreaseDoubleRule  extends VolRuleBase{

	private CandleEventTagEnum SIGN = null;//CandleTagEnum.EVNT_INCREASE_DOUBLE_VOL;
	
	
	public double range1Ratio1 = 1.75;
	public double range1Ratio2 = 2.25;
	
	private boolean isUpClose = true;
	
	public VolIncreaseDoubleRule(boolean isUpClose) {
		
		this.isUpClose = isUpClose;
		if(isUpClose) {
			SIGN = CandleEventTagEnum.EVNT_INCREASE_DOUBLE_VOL_RED;
		}else {
			SIGN = CandleEventTagEnum.EVNT_INCREASE_DOUBLE_VOL_BLACK;
		}
