...
public class FallBodyVolatileVolRule extends VolRuleBase{

	private CandleEventTagEnum SIGN = CandleEventTagEnum.EVNT_FALL_BODY_VOLATILE_VOL;
	private static double DEFAULT_VOL_1 = -0.03;
	private static double DEFAULT_VOL_2 = -0.05;
